            ...
            <TabPanel mt={'3'}>
                <Grid templateColumns={'repeat(4,1fr)'} gap={3}>
                    <GridItem w={'100%'} h='100%' colSpan={1}>
                        <Box>
                            <Image src='https://s25.picofile.com/file/8451748926/myrightel_web.png' alt='laptop' />
                        </Box>
                    </GridItem>
                    <GridItem colSpan={3}>
                        <Grid templateColumns={'repeat(3,1fr)'} gap={2}>
                        ...
                        <Grid mt={{ lg: '12', md: '12', sm: '4' }} templateColumns={'repeat(1,1fr)'}>
                            <Center>
                                <GridItem w={'70%'}>
                                    <Button _hover={{ bg: 'purple' }} fontSize={'sm'} fontWeight='light' color={'#FBF7FB'} boxShadow={'0px 1px 4px #D640D6'} borderRadius={'32px'} w={'100%'} bg='#902070'>دانلود نسخه Windows</Button>
                                </GridItem>
                            </Center>
                        </Grid>
                    </GridItem>
